...
export function PurchaseOrderImportModal({ isOpen, onClose, onSuccess }: PurchaseOrderImportModalProps) {
  ...
  const downloadSampleCsv = () => {
    const headers = "PurchaseOrderNumber,VendorName,BilledFrom,Location,DeliveryAddressType,Reference,Date,DeliveryDate,Circle,Package,ShipmentPreference,WarehouseLocation,Notes,TermsConditions,CGSTPercentage,SGSTPercentage,IGSTPercentage,ItemName,TempCode,Account,Description,LoaSerialNo,HsnCode,ItemPackage,ItemCircle,Unit,Quantity,Rate\n";
    const sampleRow1 = "PO-10001,Fastigo Tech,HQ,Mumbai HQ,Locations,REF-992,2026-07-21,2026-08-01,Mumbai,Hardware Pack 1,Air,Warehouse A,Please deliver safely,\"Net 30, Standard SLA\",9,9,0,Optical Fiber,FBR-001,Inventory,10km roll of fiber,SN-1234,8544,Hardware Pack 1,Mumbai,Roll,2,5000\n";
    const sampleRow2 = "PO-10001,Fastigo Tech,HQ,Mumbai HQ,Locations,REF-992,2026-07-21,2026-08-01,Mumbai,Hardware Pack 1,Air,Warehouse A,Please deliver safely,\"Net 30, Standard SLA\",9,9,0,Router,RTR-900,Inventory,Enterprise Router,SN-9988,8517,Hardware Pack 1,Mumbai,Pcs,5,12000\n";
                      ...
                      <div className="flex justify-between text-xs text-slate-600 mb-1">
                        <span>
                          {uploadProgress < 35 ? 'Uploading file...' :
                           ...
                           uploadProgress < 100 ? 'Saving purchase orders to database...' : 'Completed!'}
                        </span>
