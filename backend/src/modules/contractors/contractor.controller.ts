...
export const bulkImportContractorReturns = asyncHandler(async (req: Request, res: Response) => {
  ...
  for await (const row of parser) {
    try {
      ...
      const csvLoaSrNo = row['LOA Serial No'] || row['LOA Serial No.'] || row['LOA Sr. No.'] || row['LOA Sr No'] || row['Sr No.'] || row['Sr. No.'] || row['Sr No'] || row['LoaSerialNo'] || row['SerialNo'] || row['LoaSrNo'] || '';
