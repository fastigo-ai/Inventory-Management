...
export function DIImportModal({ isOpen, onClose, onSuccess }: DIImportModalProps) {
  ...
  const downloadSampleCsv = () => {
    const headers = "DINumber,PurchaseOrderNumber,VendorName,Date,Circle,Package,Notes,ItemName,TempCode,LoaSerialNo,Quantity\n";
    const sampleRow1 = "DI-20001,PO-10001,Test Vendor Ltd,2026-07-21,Mumbai,Hardware Pack 1,Ready for dispatch,Optical Fiber,FBR-001,SN-1234,2\n";
    const sampleRow2 = "DI-20001,PO-10001,Test Vendor Ltd,2026-07-21,Mumbai,Hardware Pack 1,Ready for dispatch,Router,RTR-900,SN-9988,5\n";
