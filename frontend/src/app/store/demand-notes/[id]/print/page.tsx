          ...
          <div className="flex justify-between items-end relative">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-end relative">
                ...
                {/* PD Approval Stamp */}
                {(demandNote.status === 'Approved' || demandNote.status === 'Fulfilled') && demandNote.pdApprovedBy && demandNote.pdApprovedAt && (
                  <div className="absolute left-[540px] -top-5 rotate-[5deg] border-[3px] border-blue-600 text-blue-700 p-3 rounded-md bg-white shadow-sm z-10 w-[220px]"
                    style={{ WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
                    <div className="font-bold text-lg uppercase tracking-widest border-b-[2px] border-blue-600 pb-1 mb-1 text-center">
                      AUTHORIZED
                    </div>
                    <div className="text-xs font-semibold text-center uppercase">
                      BY PD: {demandNote.pdApprovedBy.firstName} {demandNote.pdApprovedBy.lastName}
                    </div>
                    <div className="text-[10px] font-mono text-center mt-1">
                      {new Date(demandNote.pdApprovedAt).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', dateStyle: 'medium', timeStyle: 'short' })} IST
                    </div>
                  </div>
                )}
              </div>
