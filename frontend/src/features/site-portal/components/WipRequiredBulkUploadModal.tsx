...
import { uploadWipRequiredExcel } from '../api/wipRequired.api';
...
export function WipRequiredBulkUploadModal({ open, onOpenChange, onSuccess }: Props) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const res = await uploadWipRequiredExcel(formData);
      setResult(res.data);
