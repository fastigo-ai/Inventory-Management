    ...
    <div className="flex flex-col h-full bg-white relative">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-bold text-slate-800">New Purchase Invoice</h1>
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-5xl mx-auto p-8 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
             ...
             <div className="space-y-6">
                ...
                <div className="grid grid-cols-[140px_1fr] items-center gap-4">
                  <label className="text-sm font-semibold text-red-300">Purchase Invoice#*</label>
                  <div className="relative">
          ...
          <div className="flex flex-col max-w-xl gap-8 pt-4">
             ...
             {/* File Upload */}
             <div>
                <p className="text-sm font-semibold text-slate-400 mb-2">Attach File(s) to Purchase Invoice</p>
                <div className="w-48">
