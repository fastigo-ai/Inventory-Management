...
export function DIImportModal({ isOpen, onClose, onSuccess }: DIImportModalProps) {
  ...
  const downloadSampleCsv = () => {
    ...
    const sampleRow1 = "DI-20001,2026-07-21,PO-10001,Mumbai,Hardware Pack 1,Draft,Optical Fiber,2\n";
    const sampleRow2 = "DI-20001,2026-07-21,PO-10001,Mumbai,Hardware Pack 1,Draft,Router,5\n";
