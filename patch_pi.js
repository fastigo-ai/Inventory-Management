                ...
                {isSummaryLoading ? (
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={summaryData.slice(0, 15)} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                      ...
                      <RechartsTooltip formatter={(val: number) => new Intl.NumberFormat('en-IN').format(val)} />
...
content = content.replace(originalEnding, closingReplacement);
