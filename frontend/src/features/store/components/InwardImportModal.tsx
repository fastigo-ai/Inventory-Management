...
export function InwardImportModal({ isOpen, onClose, onSuccess }: InwardImportModalProps) {
  ...
  const downloadSampleCsv = () => {
    const headers = "InvoiceNumber,LoaSerialNo,ItemName,ChallanQty,RejectedQty,AcceptedQty,TransportName,TruckNumber,GrNumber,GrDate,ReceivedDate,Remarks\n";
    const sampleRow1 = "INV-1001,SN-1234,Optical Fiber,10,0,10,Fastigo Logistics,MH-12-AB-1234,GR-991,2026-07-20,2026-07-22,Delivered safely\n";
    const sampleRow2 = "INV-1001,SN-9988,Router,5,1,4,Fastigo Logistics,MH-12-AB-1234,GR-991,2026-07-20,2026-07-22,1 box damaged\n";
